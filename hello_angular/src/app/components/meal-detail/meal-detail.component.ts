...
export class MealDetailComponent implements OnInit {
  ...
  constructor(
    // IN new version, the MealDetail comp does not receive a meal to display from Meals comp anymore. It needs to get a meal id from a current url open using Angular routing module (app-routing-module.ts). See @https://v5.angular.io/tutorial/toh-pt5#routable-herodetailcomponent
  ...
  getSelectedMeal(): void {
    ...
    // The "id" key returns the str id of the meal to fetch.
